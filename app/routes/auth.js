...
module.exports = function (app, config) {
  if (config.facebook.enabled) {
    addFacebookLogin(config.facebook.scope);
  }
...
function addFacebookLogin(scope) {
  // send to Facebook to do the authentication
  router.get('/facebook', passport.authenticate('facebook', {scope: scope}));
  ...
  // send to facebook to do the authentication
  router.get('/connect/facebook', passport.authorize('facebook', {scope: scope}));
